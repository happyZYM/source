...
struct Query { int l,r,id; LL len; } b[maxn];
int a[maxn],bl[maxn],n,m,blo,cnt[maxn];
LL A[maxn],B[maxn],tot;
inline bool cmp(const Query &a,const Query &b) { return bl[a.l]!=bl[b.l]?bl[a.l]<bl[b.l]:((bl[a.l]&1)?a.r<b.r:a.r>b.r); }
